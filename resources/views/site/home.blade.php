...
@section('content')
            ...
            <div class="slider_active owl-carousel">
                @foreach ($sliders as $slider)
                    <div class="single_slide"
                        style="background-image: url({{ $slider->getFirstMediaUrl('slider') }}); background-size: cover; background-position: center;">
                        <div class="container">
                            <div class="single-slide-item-table">
                                <div class="single-slide-item-tablecell">
                                    <div class="slider_content text-right slider-animated-1">
                                        <p class="animated">{{ $slider->title }}</p>
                                        <h1 class="animated">{{ strip_tags($slider->description) }}</h1>
    ...
    <!--  Promo ITEM STRAT  -->
    <section id="promo_area" class="section_padding alignment_designs">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 professional_design">
                    <a href="{{ route('product.all') }}">
                        <div class="single_promo">
                            <img src="{{ asset('assets/site-assets/img/promo/4.jpg') }}" alt="">
                            <div class="box-content ">
                                <h3 class="title">Professional Sound</h3>
                                <div class="post">Shop Now</div>
                            </div>
                        </div>
                    </a>
                </div><!--  End Col -->

                <div class="col-lg-8 col-md-6 col-sm-12 new_release_design">
                    <a href="{{ route('product.all') }}">
                        <div class="single_promo">
                            <img src="{{ asset('assets/site-assets/img/promo/5.jpg') }}" alt="">
                            <div class="box-content">
                                <h3 class="title">New <br>Releases</h3>
                                <div class="post">Shop Now</div>
                            </div>
                        </div>
                    </a>
    ...
    <!-- Start product Area -->
    <section id="product_area" class="section_padding alignment_design">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                ...
                <div class="product_item">
                    <div class="row">
                        @foreach ($all_products as $products)
                            <div
                                class="col-lg-3 col-md-4 col-sm-6 col-6 mix 
    ...
    <!-- Special Offer Area -->
    <div class="special_offer_area py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="special_info  gray_section">
                        ...
                        <div class="brand_slide owl-carousel">
                            @foreach ($brands as $brand)
                                <div class="item text-center"> <a
                                        href="{{ route('brands.products', $brand->slug) }}"><img
                                            src="{{ $brand->getFirstMediaUrl('brand') }}" alt="{{ $brand->name }}"
    ...
    @if ($testimonials->isNotEmpty())
        <section id="testimonials" class="testimonials_area section_padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-4"><img src="{{ asset('assets/site-assets/img/review.png') }}" alt=""
                            class="img-responsive" /></a></div>
                    <div class="col-md-8">
