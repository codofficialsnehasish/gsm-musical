        ...
        <div class="container">
            ...
            <div class="d-md-flex justify-content-between" style="display:flex">
                ...
                <div class="mt-md-0">
                    ...
                    <h4>GSM Musical</h4>
                    <ul class="list-unstyled m-0">
                       <li>Kavi Nazrul Sarani, <br>Opposite Asma Dhaba, Baruipur, <br>Kolkata, India, 700144</li>
                    </ul>
                </div>
            </div>
                ...
                <h5 class="fw-bold my-4">Contact Us</h5>
                    <ul class="list-unstyled">
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="mdi:location"
                                style="vertical-align:text-bottom"></iconify-icon>Kavi Nazrul Sarani, Opposite Asma Dhaba, <br>Baruipur, Kolkata, India, 700144</li>
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="solar:phone-bold"
                                style="vertical-align:text-bottom"></iconify-icon> +91 70036 96900</li>
                        <li><iconify-icon class="social-icon text-primary fs-5 me-2" icon="ic:baseline-email"
                                style="vertical-align:text-bottom"></iconify-icon> gsmmusicalkolkata@hotmail.com</li>
                    </ul>
                </div>
