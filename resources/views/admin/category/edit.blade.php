    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <ul class="nav nav-tabs page-header-tab">
                <li class="nav-item"><a class="btn btn-info" href="{{ route('category.index') }}"><i class="fa fa-arrow-left me-2"></i>Back</a></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label" for="parent_id">Parent Category <span class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <select class="form-control input-height" id="parent_id" name="parent_id">
                                        ...
                                        @foreach($categorys as $category_data)
                                            ...
                                            @foreach ($category_data->children as $child)
                                                ...
                                                @foreach ($child->children as $childs)
                                                    <option value="{{ $childs->id }}" @if($category->parent_id == $childs->id) selected @endif>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-- {{ $childs->name }}
                                                    </option>
                                                    @foreach ($childs->children as $subchilds)
                                                    <option value="{{ $subchilds->id }}" @if($category->parent_id == $subchilds->id) selected @endif>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-- {{ $subchilds->name }}
                                                    </option>
                                                    @endforeach
                                                @endforeach
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                <div class="form-group">
                                    <input type="file" class="dropify" name="image" data-default-file="{{ $category->getFirstMediaUrl('category') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible1" name="is_visible" class="form-check-input" value="1" {{ check_uncheck($category->is_visible,1) }}>
                                        <label class="form-check-label" for="is_visible1">Show</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible2" name="is_visible" class="form-check-input" value="0" {{ check_uncheck($category->is_visible,0) }}>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_popular1" name="is_popular" class="form-check-input" value="1" {{ check_uncheck($category->is_popular,1) }}>
                                        <label class="form-check-label" for="is_popular1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_popular2" name="is_popular" class="form-check-input" value="0" {{ check_uncheck($category->is_popular,0) }}>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_special1" name="is_special" class="form-check-input" value="1" {{ check_uncheck($category->is_special,1) }}>
                                        <label class="form-check-label" for="is_special1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_special2" name="is_special" class="form-check-input" value="0" {{ check_uncheck($category->is_special,0) }}>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_home1" name="is_home" class="form-check-input" value="1" {{ check_uncheck($category->is_home,1) }}>
                                        <label class="form-check-label" for="is_home1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_home2" name="is_home" class="form-check-input" value="0" {{ check_uncheck($category->is_home,0) }}>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_menu1" name="is_menu" class="form-check-input" value="1" {{ check_uncheck($category->is_menu,1) }}>
                                        <label class="form-check-label" for="is_menu1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_menu2" name="is_menu" class="form-check-input" value="0" {{ check_uncheck($category->is_menu,0) }}>
